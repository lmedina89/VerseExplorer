...
test('Explorer 0.1.0.5C.1 cache-busts the changed landed-presentation chain for Safari/GitHub Pages', () => {
  ...
  assert.match(index, /styles\.css\?v=155-ue0105c1/);
  assert.match(index, /src\/main\.js\?v=155-ue0105c1/);
  assert.match(main, /app\/app\.js\?v=155-ue0105c1/);
  assert.match(app, /render\/threeRenderer\.js\?v=ue0105c1/);
  assert.match(threeRenderer, /surfaceWorld\.js\?v=ue0105c1/);
  assert.match(surfaceWorld, /celestialFactory\.js\?v=ue0105c1/);

  // Existing 5C Moon-landing support chain remains versioned exactly as before.
