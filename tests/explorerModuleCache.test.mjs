...
test('Explorer 0.1.0.5F cache-busts the Earth landing/atmosphere visual chain for Safari/GitHub Pages', () => {
  ...
  assert.match(index, /styles\.css\?v=ue0105f/);
  assert.match(index, /src\/main\.js\?v=ue0105f/);
  assert.match(main, /app\/app\.js\?v=ue0105f/);
  assert.match(app, /render\/threeRenderer\.js\?v=ue0105f/);
  ...
  assert.match(app, /ui\/systemMap\.js\?v=ue0105f/);
  assert.match(threeRenderer, /celestialFactory\.js\?v=ue0105f/);
  assert.match(threeRenderer, /surfaceWorld\.js\?v=ue0105f/);
  assert.match(surfaceWorld, /celestialFactory\.js\?v=ue0105f/);
  assert.match(surfaceGenerator, /surfaceProfiles\.js\?v=ue0105f/);
  assert.match(systemNavigation, /surfaceProfiles\.js\?v=ue0105f/);
  assert.match(frameOrbitInsertion, /systemNavigation\.js\?v=ue0105f/);
  assert.match(systemMap, /frameOrbitInsertion\.js\?v=ue0105f/);
  assert.match(systemMap, /systemNavigation\.js\?v=ue0105f/);
