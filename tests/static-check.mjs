...
if (!html.includes('Universe Explorer v0.1.0.5E')) throw new Error('Explorer shell version is not v0.1.0.5E.');
if (!html.includes('<div class="brand">UNIVERSE EXPLORER <span>v0.1.0.5E</span></div>')) throw new Error('Visible top-left build badge is not Universe Explorer v0.1.0.5E.');
if (!html.includes('./src/main.js?v=ue0105e')) throw new Error('v0.1.0.5E main module cache marker missing.');
...
if (!html.includes('./styles.css?v=ue0105e') || !html.includes('./src/main.js?v=ue0105e')) throw new Error('Build-version cache-busting tags missing.');
...
if (!main.includes("./app/app.js?v=ue0105e")) throw new Error('Main-to-app cache-busting import missing.');
if (!app.includes("../render/threeRenderer.js?v=ue0105e") || !app.includes("../core/astronomicalObserver.js?v=ue0105e") || !app.includes("../ui/hud.js?v=ue0105e") || !app.includes("../ui/systemMap.js?v=ue0105e") || !app.includes("../surface/surfaceSkyObserver.js?v=ue0105e") || !app.includes("../surface/surfaceGenerator.js?v=ue0105e") || !app.includes("../surface/surfaceProfiles.js?v=ue0105e") || !app.includes("../physics/frameOrbitInsertion.js?v=ue0105e")) throw new Error('App cache-busting imports missing.');
if (!renderer.includes("./cockpitView.js?v=ue0105e")) throw new Error('Cockpit renderer cache-busting import missing.');
