...
if (!html.includes('Universe Explorer v0.1.0.4A.2')) throw new Error('Explorer shell version is not v0.1.0.4A.2.');
if (!html.includes('<div class="brand">UNIVERSE EXPLORER <span>v0.1.0.4A.1</span></div>')) throw new Error('Visible top-left build badge is not Universe Explorer v0.1.0.4A.2.');
