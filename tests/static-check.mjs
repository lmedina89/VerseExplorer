...
if (!html.includes('Universe Explorer v0.1.0.5B')) throw new Error('Explorer shell version is not v0.1.0.5B.');
if (!html.includes('<div class="brand">UNIVERSE EXPLORER <span>v0.1.0.5B</span></div>')) throw new Error('Visible top-left build badge is not Universe Explorer v0.1.0.5B.');
if (!html.includes('./src/main.js?v=155-ue0105b')) throw new Error('v0.1.0.5B main module cache marker missing.');
