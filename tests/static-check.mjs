...
if (!html.includes('Universe Explorer v0.1.0')) throw new Error('Shell version is not Explorer v0.1.0.');
if (!html.includes('<div class="brand">UNIVERSE EXPLORER <span>v0.1.0</span></div>')) throw new Error('Visible top-left build badge is not Explorer v0.1.0.');
if (!html.includes('EXPLORER-010') || !html.includes('ABYSSAL-155')) throw new Error('Explorer build/source baseline markers missing.');
if (pkg.version !== '0.1.0' || pkg.name !== 'universe-explorer') throw new Error('Explorer package identity mismatch.');
...
if (!html.includes('./styles.css?v=explorer010') || !html.includes('./src/main.js?v=explorer010')) throw new Error('Explorer build cache-busting tags missing.');
...
if (!html.includes('id="menuToggle"')) throw new Error('Explorer MENU launcher missing.');
if (html.includes('id="moreToggle"')) throw new Error('Legacy redundant MORE launcher must remain removed.');
...
if (!main.includes("./app/app.js?v=explorer010")) throw new Error('Explorer main-to-app cache-busting import missing.');
...
if (versionJson.buildMarker !== 'EXPLORER-010') throw new Error('VERSION.json Explorer build marker mismatch.');
if (!String(versionJson.sourceBaseline || '').includes('ABYSSAL-155')) throw new Error('VERSION.json source baseline provenance missing.');
