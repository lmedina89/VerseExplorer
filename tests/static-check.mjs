...
if (!html.includes('Universe Explorer v0.1.0.5B.1')) throw new Error('Explorer shell version is not v0.1.0.5B.1.');
if (!html.includes('<div class="brand">UNIVERSE EXPLORER <span>v0.1.0.5B.1</span></div>')) throw new Error('Visible top-left build badge is not Universe Explorer v0.1.0.5B.1.');
if (!html.includes('./src/main.js?v=155-ue0105b1')) throw new Error('v0.1.0.5B.1 main module cache marker missing.');
...
if (!app.includes("../render/threeRenderer.js?v=ue0105b") || !app.includes("../core/astronomicalObserver.js?v=ue0105b") || !app.includes("../ui/hud.js?v=155") || !app.includes("../ui/systemMap.js?v=ue0105a") || !app.includes("../surface/surfaceSkyObserver.js?v=ue0105b1")) throw new Error('App cache-busting imports missing.');
