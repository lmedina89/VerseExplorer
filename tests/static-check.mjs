...
if (!html.includes('Universe Explorer v0.1.0.5C')) throw new Error('Explorer shell version is not v0.1.0.5C.');
if (!html.includes('<div class="brand">UNIVERSE EXPLORER <span>v0.1.0.5C</span></div>')) throw new Error('Visible top-left build badge is not Universe Explorer v0.1.0.5C.');
if (!html.includes('./src/main.js?v=155-ue0105c')) throw new Error('v0.1.0.5C main module cache marker missing.');
