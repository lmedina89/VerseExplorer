...
if (!html.includes('Universe Explorer v0.1.0.6A.2')) throw new Error('Explorer shell version is not v0.1.0.6A.2.');
if (!html.includes('<div class="brand">UNIVERSE EXPLORER <span>v0.1.0.6A.2</span></div>')) throw new Error('Visible top-left build badge is not Universe Explorer v0.1.0.6A.2.');
if (!html.includes('./src/main.js?v=ue0106a2')) throw new Error('v0.1.0.6A.2 main module cache marker missing.');
...
if (!html.includes('./styles.css?v=ue0106a2') || !html.includes('./src/main.js?v=ue0106a2')) throw new Error('Build-version cache-busting tags missing.');
...
if (!main.includes("./app/app.js?v=ue0106a2")) throw new Error('Main-to-app cache-busting import missing.');
if (!app.includes("../render/threeRenderer.js?v=ue0106a2") || !app.includes("../experiments/orbitSandbox.js?v=ue0106a2")) throw new Error('Changed 0.1.0.6A.2 app cache-busting imports missing.');
if (!renderer.includes("./surfaceWorld.js?v=ue0106a2") || !renderer.includes("./celestialFactory.js?v=ue0106a2")) throw new Error('Changed 0.1.0.6A.2 renderer visual cache-busting imports missing.');
