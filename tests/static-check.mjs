...
if (!html.includes('Universe Explorer v0.1.0.6A.3-FW2')) throw new Error('Explorer shell version is not v0.1.0.6A.3-FW2.');
if (!html.includes('<div class="brand">UNIVERSE EXPLORER <span>v0.1.0.6A.3-FW2</span></div>')) throw new Error('Visible top-left build badge is not Universe Explorer v0.1.0.6A.3-FW2.');
if (!html.includes('./src/main.js?v=ue0106a3fw2')) throw new Error('v0.1.0.6A.3-FW2 main module cache marker missing.');
...
if (!renderer.includes("./flatWorldSurface.js?v=ue0106a3fw2")) throw new Error('FW2 Flat World surface renderer bridge missing.');
