...
const BASE_DEFINITION = Object.freeze({
  ...
  scientificStatus: 'INTENTIONALLY FICTIONAL. This object is a visual anomaly only: it contributes no gravity, does not replace Earth, has no physical atmosphere or landing surface, and its local Sun/Moon lighting is isolated from the Solar System lighting model.',
  navigable: true,
  mapPriority: 5,
